 ...
 */
final class Version20230106085828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BF23A0C2E7927C74 ON future_user (email)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_BF23A0C2E7927C74 ON future_user');
